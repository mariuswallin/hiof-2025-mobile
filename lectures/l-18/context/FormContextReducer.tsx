...
type FormState = {
  status: FormStatus;
  data: Partial<Student> | null; // Her kan vi definere en mer spesifikk type for skjemadataene
};
...
type FormAction =
  ...
  | { type: typeof FORM_ACTION.UPDATE_FORM_DATA; payload: Partial<Student> }
  | { type: typeof FORM_ACTION.SET_IMAGE; payload: string | null }
...
function formReducer(state: FormState, action: FormAction): FormState {
  ...
  switch (action.type) {
    ...
    case FORM_ACTION.SET_IMAGE:
      return {
        ...state,
        data: { ...(state.data ?? {}), image: action.payload },
        status: "dirty",
      };
    // Tilfelle for å oppdatere spesifikke felt i data
