...
export default function StudentID({
  ...
  return (
    <Pressable
      // Kaller handleStudentPress-funksjonen når kortet trykkes
      onPress={handleStudentPress}
      // Dynamisk stil som endres basert på trykkstatus
      // Pressed-parameteren forteller om komponenten trykkes akkurat nå
      style={({ pressed }) => [
        styles.container,
        // Viser en annen stil hvis studenten er inaktiv
        !isActive && styles.inactiveContainer,
        // Endrer utseendet når kortet trykkes
        pressed && styles.containerPressed,
      ]}
      // Android-spesifikk ripple-effekt (bølgeeffekt ved trykk)
